...
export function BrandStorySection() {
  ...
  const coreValues = [
    {
      ...
      description:
        "50년 이상의 연구 통찰과 어세스타의 검증된 리소스를 통해 막연한 추측이 아닌 '숫자와 근거'로 개인의 특성을 증명합니다.",
    },
    {
      icon: Users,
  ...
  const missions = [
    ...
    },
    {
      ...
      description:
        "부모 스스로의 마음 상태를 점검하고 자녀 특성에 맞는 코칭 스킬을 체득하게 함으로써, 양육 스트레스를 해소하고 확신 있는 양육 환경을 조성합니다.",
    },
    {
      number: "03",
  ...
  return (
    <section id="brand-story" className="relative bg-white">
