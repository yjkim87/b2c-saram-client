...
export function SolutionSection() {
  ...
  const handleTabChange = (nextTab: AgeGroupId) => {
  ...
  return (
    <section id="solution" className="bg-[#F4F6F9] py-16 md:py-24">
      <div className="mx-auto max-w-[1000px] px-4 sm:px-6">
        ...
        <div className="pointer-events-none sticky top-[74px] z-40 mb-12 flex justify-center px-4 md:top-[90px] md:mb-16">
          <div className="pointer-events-auto inline-flex max-w-full items-center justify-start gap-1 overflow-x-auto rounded-full border border-white/50 bg-[#EEF1F6]/85 p-1.5 shadow-sm backdrop-blur-md md:justify-center [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
            {ageGroups.map((group) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "shrink-0 whitespace-nowrap rounded-full px-5 py-2.5 text-[14px] font-bold transition-all duration-300 md:px-6 md:text-[15px]",
                    isActive ? "bg-[#2B66F6] text-white shadow-md shadow-blue-500/20" : "text-slate-500 hover:text-slate-800"
                  )}
                >
