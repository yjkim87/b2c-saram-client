              ...
              {NAVIGATION.map((entry) => {
                ...
                return (
                  <div key={group.title} className="group relative">
                    ...
                    <div className="pointer-events-none absolute left-1/2 top-full z-[120] mt-3 w-56 -translate-x-1/2 translate-y-3 scale-[0.98] rounded-xl border border-[#E3D5C7] bg-[#fff] p-2 opacity-0 shadow-[0_16px_36px_rgba(37,23,15,0.12)] transition-[opacity,transform] duration-200 ease-out before:absolute before:left-0 before:right-0 before:-top-3 before:h-3 before:content-[''] group-hover:pointer-events-auto group-hover:translate-y-0 group-hover:scale-100 group-hover:opacity-100 group-focus-within:pointer-events-auto group-focus-within:translate-y-0 group-focus-within:scale-100 group-focus-within:opacity-100">
